...
void mario_walk(uint8_t n)
{
	...
	for(uint8_t x = 0; x < n; x++)
	{
		...
		for(uint8_t i = 0; i < 10; i++)
		{
		   ...
		   display_frame(mario_w2_ptr, 5);
		   display_frame(mario_w3_ptr, 5);
		}
		
		display_frame(mario_ptr, 20);
...
void kirby_wave(uint8_t n)
{
	for(uint8_t x = 0; x < n; x++)
		{ 
		display_frame(kirby1_ptr, 40);
		display_frame(kirby3_ptr, 7);
		display_frame(kirby2_ptr, 7);
		display_frame(kirby3_ptr, 7);	
		display_frame(kirby2_ptr, 7);
		display_frame(kirby3_ptr, 7);	
		}
...
void ghosty(uint8_t n)
{
	for(uint8_t x = 0; x < n; x++)
		{
		display_frame(ghost1_ptr, 20);
		display_frame(ghost2_ptr, 20);	
		}
}
...
void megaman(uint8_t n)
{
	for(uint8_t x = 0; x < n; x++)
		{
		display_frame(megaman1_ptr, 40);
		display_frame(megaman2_ptr, 40);
		display_frame(megaman3_ptr, 40);
		}
}
...
void bub(uint8_t n)
{
	for(uint8_t x = 0; x < n; x++)
		{
		display_frame(bub1_ptr, 20);
		display_frame(bub2_ptr, 10);
		display_frame(bub3_ptr, 10);
		display_frame(bub4_ptr, 10);
		display_frame(bub1_ptr, 10);
		display_frame(bub2_ptr, 10);
		display_frame(bub3_ptr, 10);
		display_frame(bub4_ptr, 10);
		display_frame(bub1_ptr, 10);
		display_frame(bub5_ptr, 50);
		}
}
...
void snake(uint8_t n)
{
	...
	{	
	 ...
	 for(uint8_t i = 0; i < 7; i++)
	  { 
		display_frame(snake1_ptr, 10);
		display_frame(snake2_ptr, 10);
	  }
	  
	  for(uint8_t i = 0; i < 2; i++)
	  { 
		display_frame(snake1_ptr, 10);
		display_frame(snake3_ptr, 10);
	  }
	}
}
...
void link(uint8_t n)
{
	...
	{	
	  ...
	  { 
		display_frame(link1_ptr, 15);
		display_frame(link2_ptr, 15);
	  }
	  
	  for(uint8_t i = 0; i < 5; i++)
	  { 
		display_frame(link3_ptr, 15);
		display_frame(link4_ptr, 15);
	  }
	  
	  for(uint8_t i = 0; i < 5; i++)
	  { 
		display_frame(link5_ptr, 15);
		display_frame(link6_ptr, 15);
	  }
	  
	  for(uint8_t i = 0; i < 5; i++)
	  { 
		display_frame(link7_ptr, 15);
		display_frame(link8_ptr, 15);
	  }
	}
}
...
void mr_saturn(uint8_t n)
{
	...
	{	
		for(uint8_t i = 0; i < 2; i++)
		  { 
			display_frame(mrs1_ptr, 25);
			display_frame(mrs2_ptr, 25);
		  }
	}
}
...
void mage(uint8_t n)
{
	...
	{	
	  for(uint8_t i = 0; i < 5; i++)
	  { 
		display_frame(bm1_ptr, 20);
		display_frame(bm2_ptr, 20);
	  }
	  
	  for(uint8_t i = 0; i < 5; i++)
	  { 
		display_frame(bm3_ptr, 20);
		display_frame(bm4_ptr, 20);
	  }
}
}
...
void sonic(uint8_t n)
{
	for(uint8_t j = 0; j < n; j++)
	{
		display_frame(sonic1_ptr, 90);
		display_frame(sonic2_ptr, 5);
		display_frame(sonic3_ptr, 50);
		display_frame(sonic2_ptr, 5);
